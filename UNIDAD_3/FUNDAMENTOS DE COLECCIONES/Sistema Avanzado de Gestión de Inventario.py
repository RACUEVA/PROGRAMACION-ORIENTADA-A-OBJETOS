import json  # Importación necesaria para trabajar con JSON
...
class Inventario:
    ...
    def cargar_inventario_json(self, archivo):
        try:
            ...
            print("Error al decodificar el archivo JSON. Verifique que el archivo esté en el formato correcto.")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Estas sliendo del sistema...")
            break
